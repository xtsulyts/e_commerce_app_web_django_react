...
SECRET_KEY = 'django-insecure-ig0*&s!y64h48(vy%$&p#zv4@*h!b()o(0l5j3gd^=vy2xlan!'
...
# settings.py
AUTH_USER_MODEL = 'core.User'  # Usar nuestro modelo personalizado
...
# Si necesitas permitir credenciales (cookies, tokens):
