# Generated by Django 5.1.6 on 2025-03-30 10:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('deportivo', 'Deportivo'), ('utilitario', 'Utilitario')], max_length=20)),
                ('gender', models.CharField(choices=[('hombre', 'Hombre'), ('mujer', 'Mujer'), ('unisex', 'Unisex'), ('niño', 'Niño')], max_length=10)),
